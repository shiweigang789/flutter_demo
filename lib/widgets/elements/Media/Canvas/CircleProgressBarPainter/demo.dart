...
class CustomCircleProgressBarViewPage extends StatefulWidget {
  @override
  _CustomCircleProgressBarViewPageState createState() =>
      _CustomCircleProgressBarViewPageState();
}

class _CustomCircleProgressBarViewPageState
    extends State<CustomCircleProgressBarViewPage>
...
class CircleProgressBarPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    canvas.drawCircle(Offset(size.width / 2, size.width / 2), size.width / 2,
        _paintBackground);
