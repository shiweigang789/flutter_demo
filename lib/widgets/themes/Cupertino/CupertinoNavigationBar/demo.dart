...
class CupertinoNavigationBarFullDefault extends StatefulWidget {
  @override
  _CupertinoNavigationBarFullDefaultState createState() =>
      _CupertinoNavigationBarFullDefaultState();
}

class _CupertinoNavigationBarFullDefaultState
    extends State<CupertinoNavigationBarFullDefault> {
  ...
  Widget navigationBar(BuildContext context) {
    return CupertinoPageScaffold(
      ...
      navigationBar: CupertinoNavigationBar(
          ...
          // 用于 导航栏中前导和尾随小部件的文本和图标的默认颜色。
          backgroundColor: CupertinoColors.activeGreen,
          // 导航栏的背景颜色。如果它包含透明度，标签栏将自动对其背后的内容产生模糊效果
          border: Border(
            // 边框样式
